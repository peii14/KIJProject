#ifndef NativeAesEncrypt_H
#define NativeAesEncrypt_H
...
protected:
    ...
    static unsigned constexpr char mul2[] =
    {
    ...
    static unsigned constexpr char mul3[] =
    {
...
public:
    ...
    void ExecuteEncrypt(string filePath);
    void readImage(string imagePath);
};

#endif // NativeAesEncrypt_H
